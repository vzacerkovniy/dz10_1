...
def test_filter_by_currency(transactions_list: list) -> None:
    assert filter_by_currency(transactions_list, "USD") == [
        {
            "id": 939719570,
            "state": "EXECUTED",
    ...
    assert filter_by_currency(transactions_list, "RUB") == [
        {
            "id": 873106923,
            "state": "EXECUTED",
    ...
    assert filter_by_currency(transactions_list, "EUR") == ["Валюта не поддерживается"]
